package com.ntndev.basicspringboot.controller;


import com.ntndev.basicspringboot.model.Greeting;
...
private static final String greetingTemplate = "Hello, %s %s";
    private final AtomicLong counter = new AtomicLong(); // tang dan id
